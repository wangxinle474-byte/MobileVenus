"""Per-action eval for v9a_cleanwb (v9a retrained with regenerated clean-prompt wb data)."""
...
def main():
    ...
    ckpt = torch.load('checkpoints/lut_v9a_cleanwb/best.pt',
    ...
    print(f'\nv9a_cleanwb best_val_psnr={ckpt.get("val_psnr",0):.2f}dB '
          f'@ Ep{ckpt.get("epoch","?")}')
    print(f'\nv9a_cleanwb Per-action PSNR:')
