...
$TrainFiles = @(
    ...
    # 训练脚本 (training/legacy 归档 + 根目录活动)
    "training/legacy/train_v6_stage_a.py",
    "training/legacy/train_v6_stage_b.py",
...
$Dirs = @(
    ...
    "training/fivek_8param", "training/legacy", "scripts", "tools", "tools/eval", "tools/data", "tools/train"
)
